---
title: "How to Embed Calendly in Your ClickFunnels Funnel for Booking Strategy Calls"
description: "Embed Calendly in ClickFunnels for strategy call bookings — setup, iframe embed, automation tags, and confirmation emails."
author: "Carlos E. Vargas"
type: "tutorial"
tags: ["Calendly", "ClickFunnels", "booking", "scheduling"]
...
# How to Embed Calendly in Your ClickFunnels Funnel for Booking Strategy Calls

**Meta Description:** Learn how to embed Calendly in ClickFunnels to build a strategy call booking page. Step-by-step guide covering setup, embed code, automation tags, and mobile testing.
**Target Keywords:** embed calendly in clickfunnels, calendly clickfunnels integration
**Secondary Keywords:** clickfunnels booking page, how to add scheduling to clickfunnels, calendly embed funnel
...
## Step 1: Set Up Your Calendly Account and Strategy Call Event
...
### Add Pre-Call Qualification Questions
...
1. **"What type of business do you run?"** (short text or dropdown) -- This tells you who you are talking to before you pick up the phone.
2. **"What is your approximate monthly revenue stage?"** (dropdown: Pre-revenue / Under $5K/mo / $5K-$25K/mo / $25K+/mo) -- This qualifies the lead financially so you can tailor your recommendations.
3. **"What is the single biggest technology challenge in your business right now?"** (paragraph text) -- This is gold. Their answer tells you exactly what they care about, what language they use, and what solution to lead with on the call.
...
### Sync Calendly with Your Personal Calendar
...
## Step 2: Build the Booking Page in ClickFunnels
...
- A quick assessment of your current tech stack
- The one or two highest-impact improvements for your business stage
- A clear next-step recommendation (whether that involves working together or not)
...
- One or two short testimonials from past strategy call participants (social proof that the call is worth their time)
- Your credentials or brief bio with a photo (people want to know who they are getting on a call with)
- A "What to Expect" section that outlines what happens on the call and what happens after

**FAQ section.** Answer the three to five most common objections:

- "Is this really free?" Yes, no strings attached.
- "Will you try to sell me something?" We will share how we can help if it is relevant, but the call is focused on giving you a clear action plan regardless.
- "What if I need to reschedule?" You will receive a confirmation email with a reschedule link. No penalties.
- "I am not very technical. Is this call still useful for me?" Absolutely. That is exactly who this call is designed for.
- "How should I prepare?" Just be ready to talk about your business, your goals, and where you are getting stuck with technology.
...
## Step 3: Embed Calendly via Inline Embed Code
...
2. Click on your Strategy Call event type
3. Click **Share** (or the share icon)
4. Select **Add to Website**
5. Choose **Inline Embed** (not popup or widget -- inline displays the full calendar directly on the page, which converts better because there is no extra click)
6. Calendly will generate an HTML snippet that looks something like this:
...
7. Copy this entire code block.

### Add the Embed to Your ClickFunnels Page

1. Open your `/strategy-call` page in the ClickFunnels editor
2. Navigate to the section where you want the calendar to appear
3. Add a **Custom HTML** element (sometimes labeled "Custom JS/HTML" depending on your ClickFunnels version)
4. Paste the Calendly inline embed code into the custom HTML block
5. Adjust the `style` attribute for proper display:
...
- Can you see the full calendar without it being cut off?
- Can you scroll through available dates and times?
- Can you tap a time slot and complete the booking?
- Do the qualification questions display correctly on a small screen?
...
## Step 4: Connect the Booking to ClickFunnels Tags and Automation
...
1. **Apply a "call-booked" tag** to their contact record in ClickFunnels
2. **Trigger automation changes**: remove them from your general welcome or nurture sequence (they have already taken the desired action) and enter them into a Pre-Call email sequence

### How to Connect: Zapier Webhook
...
2. Set the trigger app to **Calendly** and the trigger event to **Invitee Created**
3. Connect your Calendly account and select the Strategy Call event type
4. Set the action app to **ClickFunnels** and the action event to **Apply Tag**
5. Map the invitee's email address from the Calendly trigger to the contact lookup field in ClickFunnels
6. Set the tag to "call-booked"
...
- A warm thank-you and confirmation of the date and time
- What to prepare: "Before our call, think about the one technology or automation challenge that is costing you the most time or revenue right now."
- A link to reschedule (Calendly includes this automatically)
- Your brief bio and photo, so they feel like they know who they are meeting

### Reminder Emails

Set up two reminders in Calendly:

- **24 hours before the call:** "Looking forward to our strategy call tomorrow. Here is what we will cover and how to get the most out of our 15 minutes."
- **1 hour before the call:** "We are on in one hour. Here is the meeting link. See you soon."
...
### Calendly Embed Not Displaying on Mobile
...
**Related reading:**
- [The AI-Powered Sales Funnel: How to Use AI at Every Stage](/blog/04-ai-powered-sales-funnel) -- See how AI tools can accelerate funnel building, from ad copy to conversion.
- [All Services](/services) -- Explore the full range of technology consulting, funnel building, and AI integration services.
